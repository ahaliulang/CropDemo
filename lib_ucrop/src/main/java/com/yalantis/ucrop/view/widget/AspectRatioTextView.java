...
public class AspectRatioTextView extends AppCompatTextView {
    ...
    public void setActiveColor(@ColorInt int activeColor) {
        ...
        setActiveColor(activeColor, ContextCompat.getColor(getContext(), R.color.ucrop_color_widget));
    }

    public void setActiveColor(@ColorInt int activeColor,@ColorInt int inactiveColor) {
        applyActiveColor(activeColor,inactiveColor);
        invalidate();
    }
...
//            canvas.drawCircle(x, y, mDotSize / 2f, mDotPaint);
    ...
    private void init(@NonNull TypedArray a) {
        ...
        applyActiveColor(activeColor,ContextCompat.getColor(getContext(), R.color.ucrop_color_widget));

        a.recycle();
    }

    private void applyActiveColor(@ColorInt int activeColor,@ColorInt int inactiveColor) {
        if (mDotPaint != null) {
